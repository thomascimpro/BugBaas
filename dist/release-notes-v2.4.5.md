...
![BugBaas 2.4 update](https://github.com/thomascimpro/cimpro-bugbaas/releases/download/v2.4.5/bugbaas-2.4.0-release-card.png)
...
## 2.4.5 hotfix
- Ruilen accepteren geeft nu directe knop-feedback en toont fouten als popup.
- Firestore trade-rules accepteren nu per bug maximaal 6 stuks, gelijk aan de app-limiet per ruilkant.
